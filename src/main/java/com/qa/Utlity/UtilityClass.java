...
public class UtilityClass {
	...
	public static String getDataFromexcel(int rowindex, int colindex) throws EncryptedDocumentException, IOException {
		...
		FileInputStream file = new FileInputStream(
				"C:\\Auto\\Backup\\10-5-23\\capgemini\\TestData\\ValidationMessage.xlsx");
		String data = WorkbookFactory.create(file).getSheet("Sheet1").getRow(rowindex).getCell(colindex)
				.getStringCellValue();
		return data;
	}
	...
	public static void getScreenShot(String Screen, int TestcaseID, WebDriver driver) throws IOException {
		...
		File Dest = new File(
				"C:\\Auto\\Backup\\10-5-23\\capgemini\\Screenshot\\" + Screen + "-" + dateformat.format(date) + ".png");
